...
describe('GitHubAPI', () => {
    ...
    describe('listFiles', () => {
        ...
        it('should list files matching CLAUDE.md pattern', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(`https://api.github.com/repos/${owner}/${repo}/git/trees/${branch}?recursive=1`, {
                headers: {
    ...
    describe('getFileContent', () => {
        ...
        it('should get file content with base64 encoding', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(`https://api.github.com/repos/${owner}/${repo}/contents/${filePath}?ref=${branch}`, {
                headers: {
                    'Accept': 'application/vnd.github.v3+json',
                    'User-Agent': 'omni-mcp-hub/1.0.0'
                }
    ...
    describe('getRateLimit', () => {
        it('should get rate limit information', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://api.github.com/rate_limit', {
                headers: {
                    'Accept': 'application/vnd.github.v3+json',
                    'User-Agent': 'omni-mcp-hub/1.0.0'
                }
