...
describe('SecurityRulesLoader', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        security_rules_loader_1.SecurityRulesLoader.instance = undefined;
        console.log = jest.fn();
        console.warn = jest.fn();
        console.error = jest.fn();
        delete process.env.SECURITY_RULES_PATH;
        loader = security_rules_loader_1.SecurityRulesLoader.getInstance();
    });
    afterEach(() => {
        loader.rules = null;
    });
    describe('getInstance', () => {
        it('should return singleton instance', () => {
            const instance1 = security_rules_loader_1.SecurityRulesLoader.getInstance();
            const instance2 = security_rules_loader_1.SecurityRulesLoader.getInstance();
            expect(instance1).toBe(instance2);
            expect(instance1).toBeInstanceOf(security_rules_loader_1.SecurityRulesLoader);
        });
        it('should create new instance only once', () => {
            const spy = jest.spyOn(security_rules_loader_1.SecurityRulesLoader, 'getInstance');
            const instance1 = security_rules_loader_1.SecurityRulesLoader.getInstance();
            const instance2 = security_rules_loader_1.SecurityRulesLoader.getInstance();
    ...
    describe('getDefaultRules', () => {
        it('should return comprehensive default security rules', () => {
            const defaultRules = loader.getDefaultRules();
    ...
    describe('reloadRules', () => {
        ...
        it('should clear cached rules before reloading', () => {
            ...
            mockFs.existsSync.mockReturnValue(false);
            loader.reloadRules();
            expect(loader.rules).not.toBe(cachedRules);
        });
