...
describe('MCPHandler', () => {
    ...
    beforeEach(() => {
        ...
        mcpHandler = new mcp_handler_1.MCPHandler(mockSourceManager, mockMCPServerManager);
        mockRequest = {
            body: {}
        };
        mockResponse = {
    ...
    describe('Tools Management', () => {
        describe('tools/list', () => {
            ...
            it('should include bundle tool when bundle mode is enabled', async () => {
                ...
                expect(response.result.tools.find((t) => t.name === 'get_source_bundle')).toBeDefined();
            });
            it('should include MCP server tools', async () => {
                ...
                const response = await mcpHandler.handleMessage(message);
                expect(response.result.tools).toHaveLength(5);
                expect(response.result.tools.find((t) => t.name === 'arxiv__search_papers')).toBeDefined();
            });
        ...
        describe('tools/call', () => {
            ...
            it('should call get_source_file tool with safe content', async () => {
                ...
                MockContentValidator.shouldAddSafetyNotice.mockReturnValue(null);
                const message = {
                    jsonrpc: '2.0',
                    id: 1,
                    method: 'tools/call',
            ...
            it('should block unsafe content in get_source_file', async () => {
                ...
                MockContentValidator.shouldAddSafetyNotice.mockReturnValue('high_risk');
                const message = {
                    jsonrpc: '2.0',
                    id: 1,
                    method: 'tools/call',
                ...
                expect(console.warn).toHaveBeenCalledWith(expect.stringContaining('High-risk content detected'));
            });
            ...
            it('should call MCP server tool', async () => {
                ...
                expect(mockMCPServerManager.callTool).toHaveBeenCalledWith('arxiv__search_papers', { query: 'machine learning' });
            });
    ...
    describe('Bundle Tool', () => {
        ...
        it('should handle blocked files in bundle', async () => {
            ...
            mockSourceManager.getSourceFiles.mockResolvedValue(files);
            MockContentValidator.shouldAddSafetyNotice
    ...
    describe('Express Integration', () => {
        it('should process valid requests through Express', async () => {
            ...
            await mcpHandler.process(mockRequest, mockResponse);
