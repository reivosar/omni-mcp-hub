...
echo "   /use apply_claude_config filePath:\"./lum-behavior.md\" profileName:\"lum\""
echo "   /use list_claude_configs"
echo "   /use get_applied_config"
echo ""
echo -e "${RED}⚠️  Auto-Apply Note:${NC}"
echo "   Profiles with autoApply:true are loaded but require manual application in Claude Code."
echo "   To apply the lum profile, run: ${YELLOW}/use apply_claude_config lum-behavior${NC}"
echo ""
